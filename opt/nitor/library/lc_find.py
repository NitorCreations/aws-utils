...
# Look up AWS EC2 launch configurations
# From https://github.com/atplanet/ansible-auto-scaling-tutorial under Apache License 2.0
...
def main():
    ...
    argument_spec.update(dict(
        ...
        aws_profile = dict(required=False)
    )
    )
    ...
    cmd_line = ["aws", "autoscaling", "describe-launch-configurations", "--region",  module.params.get('region')]
    if aws_profile:
        cmd_line.extend(["--profile", module.params.get('aws_profile')])
    lc_cmd_result = subprocess.check_output(cmd_line)
